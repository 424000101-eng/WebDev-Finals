...
<head>
    ...
    <!-- We link Bootstrap here too so it looks pretty! -->
    ...
    <div class="container py-5">
        <div class="row justify-content-center">
            <div class="col-md-8">
                ...
                <?php if (!empty($errors)): ?>
                    <!-- RED BOX: If the user or a hacker bypassed the form with mistakes -->
                    <div class="card border-danger shadow-sm">
                        <div class="card-header bg-danger text-white fw-bold">Data Validation Failure</div>
                        <div class="card-body">
                ...
                <?php else: ?>
                    <!-- GREEN BOX: Everything is clean and secure! -->
                    <div class="card border-success shadow-sm">
                        <div class="card-header bg-success text-white fw-bold">Transmission Successfully Authenticated</div>
                        <div class="card-body">
                            <!-- We use htmlspecialchars() here to stop XSS malicious script code injections! -->
                            <h3 class="h5 mb-4 text-success">Thank you, <?php echo htmlspecialchars($name); ?>! Your message has been received.</h3>
                            ...
                            <div class="alert alert-info small mt-4">
                                <strong>Security Notice:</strong> Outputs were fully escaped using server-side <code>htmlspecialchars()</code> parsing to successfully neutralize cross-site scripting (XSS) vectors.
                            </div>
